        ...
        <>
            ...
            <div className="flex gap-4 items-center px-4 py-2 text-white">
                <a
                    ...
                    aria-label="LinkedIn"
                    className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-blue-600/20 transition-colors"
                >
            ...
            <div className="flex w-full items-center justify-between sm:hidden">
                ...
                <div className="flex items-center gap-2 w-full justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {/* LinkedIn and Email icons (mobile) */}
                        <a
                            href="https://www.linkedin.com/in/venkatarohithpesala/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        >
                            <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="inline-block align-middle">
